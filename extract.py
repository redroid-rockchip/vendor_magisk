...
def main():
    ...
    overlay_path = os.path.join(current_path, "arm64", "ksigam")
    ...
    overlay_path = os.path.join(current_path, "arm64_only", "ksigam")
    shutil.rmtree(overlay_path, ignore_errors=True)
    os.makedirs(overlay_path, exist_ok=True)
    ...
    overlay_path = os.path.join(current_path, "x86_64", "ksigam")
    shutil.rmtree(overlay_path, ignore_errors=True)
    os.makedirs(overlay_path, exist_ok=True)
    ...
    overlay_path = os.path.join(current_path, "x86_64_only", "ksigam")
    shutil.rmtree(overlay_path, ignore_errors=True)
    os.makedirs(overlay_path, exist_ok=True)
